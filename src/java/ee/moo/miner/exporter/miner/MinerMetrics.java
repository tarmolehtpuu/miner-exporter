...
import ee.moo.miner.exporter.client.prometheus.*;

import java.util.ArrayList;
import java.util.List;

import static ee.moo.miner.exporter.client.prometheus.Metric.counter;
import static ee.moo.miner.exporter.client.prometheus.Metric.gauge;
